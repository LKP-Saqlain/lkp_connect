...
const MfReport = (props: any) => {
  ...
  //             //   const date = new Date();
  //             //   let sipdate = Number(allSipData[3].startDate.split("-")[0]); //24-Jul-2023 gives me 24
  //             //   let todaysDate = date.getDay();
  //             //   let maxdate = todaysDate + 15;
  //             //   console.log(sipdate, todaysDate, maxdate, "sipdate todaysDate");

  //             //   // condition is sort it ascending form from todays date to next 15 days
  ...
  //             // }
  //             const parseSipDate = (dateStr: any) => {
  //               const [day, mon, year] = dateStr.split("-");
  //               return new Date(`${mon} ${day}, ${year}`);
  //             };

  //             // Mapping month abbreviations to numbers handled automatically by JS Date()

  //             const getNextSipDate = (startDateStr: any) => {
  ...
  //             next15.setDate(today.getDate() + 16);

  //             const upcomingSIPs = allSipData.filter((sip: any) => {
  //               const nextInstallment = getNextSipDate(sip.startDate);
  ...
  //             upcomingSIPs.sort(
  //               (a, b) =>
  //                 getNextSipDate(a.startDate).getTime() -
  //                 getNextSipDate(b.startDate).getTime()
  //             );
  ...
  // Helper functions (add these ABOVE the useEffect)
